...
//            update_frame();
            ...
            if (score_change_count >= 1000) {
                ...
                current_accuracy = (float)((float)(current_score_0 + current_score_1) /
                		(float)number_of_trials);
//                accum hold = (accum)((accum)current_score / (accum)number_of_trials);
                io_printf(IO_BUF,
                		"accuracy:%k, current_score_0:%u, current_score_1:%u, num trials:%u\n",
						(accum)current_accuracy, current_score_0,
						current_score_1, number_of_trials);
